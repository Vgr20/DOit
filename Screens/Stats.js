...
const Stats = (poses) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Text style={{ fontFamily: 'Satisfy-Regular', fontSize: 45, color: 'white', fontWeight: 'bold', marginVertical: 30,}}>
            ...
            <Text style = {{fontSize:20, color: 'white', textAlign: 'center', top: 235}}>
            ...
            <Text style = {{fontFamily: 'Satisfy-Regular', fontSize: 30, color: 'white', textAlign: 'center', top: 255}}>
                What is your reflection today?
            </Text> 

            <View style = {{flexDirection : 'column', alignItems: 'center', marginHorizontal : 15, marginVertical: 125}}>
                <TextInput
